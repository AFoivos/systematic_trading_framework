# Experiment Report: ethusd_30m_trial0041_sig_rule_momentum_v1

## Overview
- Config path: `/workspace/config/experiments/foundation_alpha/ethusd_30m_trial_0041_alpha_lab/05_signal_lab/ethusd_30m_trial0041_sig_rule_momentum_v1.yaml`
...
```yaml
config_path: /workspace/config/experiments/foundation_alpha/ethusd_30m_trial_0041_alpha_lab/05_signal_lab/ethusd_30m_trial0041_sig_rule_momentum_v1.yaml
runtime:
  seed: 7
  repro_mode: strict
  deterministic: true
...
- `signal[momentum]` -> `src.signals.momentum_strategy.momentum_strategy(df: 'pd.DataFrame', momentum_col: 'str', long_threshold: 'float' = 0.0, short_threshold: 'float | None' = None, signal_col: 'str | None' = None, mode: 'str' = 'long_short_hold') -> 'pd.Series'`  
  params={'momentum_col': 'rolling_return_24', 'long_threshold': 0.01, 'short_threshold': -0.01, 'signal_col': 'signal_rule_momentum', 'mode': 'long_short'}

```yaml
signals:
  kind: momentum
  params:
    momentum_col: rolling_return_24
    long_threshold: 0.01
    short_threshold: -0.01
    signal_col: signal_rule_momentum
    mode: long_short
  outputs: {}
```
...
| Metric | Value |
| --- | --- |
| cumulative_return | 0.190508 |
| annualized_return | 0.072242 |
| annualized_vol | 0.509849 |
| sharpe | 0.141693 |
| sortino | 0.203528 |
| calmar | 0.139711 |
| max_drawdown | -0.517085 |
| profit_factor | 1.013460 |
| hit_rate | 0.478938 |
| avg_turnover | 0.039475 |
| total_turnover | 1.729e+03 |
| gross_pnl | 0.672141 |
| net_pnl | 0.499241 |
| total_cost | 0.172900 |
| cost_drag | 0.172900 |
| cost_to_gross_pnl | 0.257238 |
| flat_rate | 0.506096 |
| long_rate | 0.251142 |
| short_rate | 0.242763 |
| trade_count | 865 |
| average_r | 0.188312 |
| median_r | -0.043074 |
| avg_max_favorable_r | 3.506828 |
| avg_max_adverse_r | -2.566948 |
| loser_was_positive_rate | 0.986456 |
| avg_giveback_r | 3.318516 |
| avg_capture_ratio | -3.433517 |
| robustness_walk_forward_positive_fold_ratio | 0.400000 |
| robustness_walk_forward_min_fold_cumulative_return | -0.281725 |
| robustness_walk_forward_worst_fold_max_drawdown | -0.454264 |
| robustness_walk_forward_mean_fold_sharpe | 0.123098 |
| robustness_walk_forward_std_fold_sharpe | 0.577773 |
| robustness_cost_x1_cumulative_return | 0.189852 |
| robustness_cost_x1_sharpe | 0.107135 |
| robustness_cost_x1_max_drawdown | -0.517085 |
| robustness_cost_x1_profit_factor | 1.013444 |
| robustness_cost_x2_cumulative_return | 0.000620 |
| robustness_cost_x2_sharpe | 0.000374 |
| robustness_cost_x2_max_drawdown | -0.546956 |
| robustness_cost_x2_profit_factor | 1.008749 |
| robustness_cost_x3_cumulative_return | -0.158535 |
| robustness_cost_x3_sharpe | -0.102040 |
| robustness_cost_x3_max_drawdown | -0.579669 |
| robustness_cost_x3_profit_factor | 1.004087 |
| robustness_cost_x5_cumulative_return | -0.404966 |
| robustness_cost_x5_sharpe | -0.294482 |
| robustness_cost_x5_max_drawdown | -0.678016 |
| robustness_cost_x5_profit_factor | 0.994863 |
| robustness_delay_1_bars_cumulative_return | -0.631580 |
| robustness_delay_1_bars_sharpe | -0.222996 |
| robustness_delay_1_bars_max_drawdown | -0.884189 |
| robustness_delay_1_bars_profit_factor | 1.003002 |
| robustness_delay_2_bars_cumulative_return | -0.409675 |
| robustness_delay_2_bars_sharpe | -0.121879 |
| robustness_delay_2_bars_max_drawdown | -0.862772 |
| robustness_delay_2_bars_profit_factor | 1.006778 |
...
| signal_rows | 43800 |
| mean_abs_signal | 0.493904 |
| signal_turnover | 0.133904 |
| long_rate | 0.251142 |
| short_rate | 0.242763 |
| flat_rate | 0.506096 |
| executed_trade_count | 23078 |
| trade_rate | 0.526895 |
| avg_signal_executed | 0.014906 |
| avg_pred_prob_executed | 0.499947 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| model_strategy | 0.190508 | 0.072242 | 0.509849 | 0.141693 | 0.203528 | 0.139711 | -0.517085 | 1.013460 | 0.478938 | 1.729e+03 | 0.257238 |
| buy_and_hold | -0.102619 | -0.042385 | 0.665486 | -0.063691 | -0.089284 | -0.056670 | -0.747935 | 1.006790 | 0.507216 | 1.000000 | 0.000224 |
| random_sign_same_rate | -0.121456 | -0.050477 | 0.522619 | -0.096585 | -0.135961 | -0.074897 | -0.673955 | 1.005457 | 0.488062 | 2.106e+03 | 0.497905 |
...
| median_fold_return | 0.071501 |
| mean_fold_return | 0.080828 |
| fold_return_std | 0.287619 |
| worst_fold_return | -0.330927 |
| best_fold_return | 0.774469 |
| worst_3_fold_average_return | -0.180157 |
| profitable_fold_count | 7.000000 |
| profitable_fold_rate | 0.700000 |
| median_fold_sharpe | 0.611647 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| atr_pct_rank_192 | low | 1.358e+04 | 0.019531 | 0.076854 | -0.247295 | 1.008489 | 0.431935 |
| atr_pct_rank_192 | medium | 2.167e+04 | 0.025457 | 0.043615 | -0.255951 | 1.008798 | 0.366111 |
| atr_pct_rank_192 | high | 8.547e+03 | 0.703963 | 2.428031 | -0.305607 | 1.055202 | 0.051164 |
| bollinger_bandwidth_rank_192 | low | 2.251e+04 | -0.334736 | -0.605688 | -0.443517 | 0.984180 | 0.484467 |
| bollinger_bandwidth_rank_192 | high | 2.129e+04 | -0.033457 | -0.046948 | -0.314136 | 1.008332 | 0.331354 |
| ema_trend_48_192 | negative | 2.183e+04 | -0.159051 | -0.220993 | -0.578557 | 1.001960 | 0.684547 |
| ema_trend_48_192 | positive | 2.197e+04 | -0.020663 | -0.036783 | -0.425104 | 1.006091 | 0.459978 |
| range_to_atr | calm | 2.190e+04 | -0.149893 | -0.587736 | -0.352793 | 0.984953 | 2.016160 |
| range_to_atr | shock | 2.190e+04 | 0.104900 | 0.116144 | -0.516112 | 1.013827 | 0.184289 |
...
| --- | --- |
| loser_was_positive_rate | 0.986456 |
| avg_mfe_r_of_losers | 1.456956 |
| median_mfe_r_of_losers | 1.063097 |
| avg_mfe_r_before_loss | 1.456956 |
| median_mfe_r_before_loss | 1.063097 |
| loser_reached_0_5r_rate | 0.762980 |
| loser_reached_1r_rate | 0.525959 |
| loser_reached_1_5r_rate | 0.352144 |
| loser_reached_2r_rate | 0.239278 |

### Capture / Giveback
| Metric | Value |
| --- | --- |
| avg_capture_ratio | -3.433517 |
| median_capture_ratio | -0.019142 |
| avg_giveback_r | 3.318516 |
| median_giveback_r | 2.725577 |
| avg_giveback_r_winners | 2.793469 |
| avg_giveback_r_losers | 3.818674 |
| median_giveback_r_winners | 2.378465 |
| median_giveback_r_losers | 3.200195 |

### MAE Before Win
| Metric | Value |
| --- | --- |
| winner_had_negative_mae_rate | 0.978673 |
| winner_had_mae_below_minus_0_25r_rate | 0.869668 |
| winner_had_mae_below_minus_0_5r_rate | 0.708531 |
| winner_had_mae_below_minus_1r_rate | 0.459716 |
| avg_mae_r_of_winners | -1.204364 |
| median_mae_r_of_winners | -0.938718 |
| p90_abs_mae_r_of_winners | 2.574635 |
| avg_mae_r | -2.566948 |
| median_mae_r | -1.853334 |
| q10_mae_r | -5.509636 |
| q25_mae_r | -3.384561 |
| q75_mae_r | -0.868607 |
| q90_mae_r | -0.372659 |
...
| Metric | Value |
| --- | --- |
| prob_final_win | 0.487861 |
| prob_final_loss | 0.512139 |
| prob_final_win_given_mae_gt_minus_0_5r | 0.976190 |
| prob_final_win_given_mae_gt_minus_1r | 0.915663 |
| prob_mfe_ge_0_5r | 0.878613 |
| prob_final_loss_given_mfe_ge_0_5r | 0.444737 |
| prob_mfe_ge_1r | 0.741040 |
| prob_final_loss_given_mfe_ge_1r | 0.363495 |
| prob_mfe_ge_1_5r | 0.626590 |
| prob_final_loss_given_mfe_ge_1_5r | 0.287823 |
| prob_mfe_ge_2r | 0.532948 |
| prob_final_loss_given_mfe_ge_2r | 0.229935 |
...
| Metric | Value |
| --- | --- |
| avg_time_to_mfe | 12.319075 |
| median_time_to_mfe | 10.000000 |
| avg_time_to_mae | 11.415029 |
| median_time_to_mae | 11.000000 |
| prob_mfe_ge_0_5r_within_1_bar | 0.086705 |
| prob_mfe_ge_0_5r_within_2_bars | 0.130636 |
| prob_mfe_ge_1r_within_4_bars | 0.137572 |
...
| avg_r_by_bars_held_bucket.17+ | 0.188312 |
...
| win_rate_by_bars_held_bucket.17+ | 0.487861 |

### Counterfactual Exits
| Metric | Value |
| --- | --- |
| counterfactual.baseline.trade_count | 865 |
| counterfactual.baseline.avg_r | 0.188312 |
| counterfactual.baseline.median_r | -0.043074 |
| counterfactual.baseline.win_rate | 0.487861 |
| counterfactual.baseline.profit_factor | 1.155691 |
| counterfactual.breakeven_after_0_5r.trade_count | 865 |
| counterfactual.breakeven_after_0_5r.avg_r | -0.090695 |
| counterfactual.breakeven_after_0_5r.median_r | 0.0 |
| counterfactual.breakeven_after_0_5r.win_rate | 0.019653 |
| counterfactual.breakeven_after_0_5r.profit_factor | 0.459635 |
| counterfactual.breakeven_after_1_0r.trade_count | 865 |
| counterfactual.breakeven_after_1_0r.avg_r | -0.272666 |
| counterfactual.breakeven_after_1_0r.median_r | 0.0 |
| counterfactual.breakeven_after_1_0r.win_rate | 0.112139 |
| counterfactual.breakeven_after_1_0r.profit_factor | 0.522054 |
| counterfactual.exit_at_first_0_5r.trade_count | 865 |
| counterfactual.exit_at_first_0_5r.avg_r | 0.295743 |
| counterfactual.exit_at_first_0_5r.median_r | 0.500000 |
| counterfactual.exit_at_first_0_5r.win_rate | 0.927168 |
| counterfactual.exit_at_first_0_5r.profit_factor | 2.762043 |
| counterfactual.exit_at_first_1_0r.trade_count | 865 |
| counterfactual.exit_at_first_1_0r.avg_r | 0.208261 |
| counterfactual.exit_at_first_1_0r.median_r | 1.000000 |
| counterfactual.exit_at_first_1_0r.win_rate | 0.789595 |
| counterfactual.exit_at_first_1_0r.profit_factor | 1.365052 |
| counterfactual.partial_50pct_at_1r.trade_count | 865 |
| counterfactual.partial_50pct_at_1r.avg_r | 0.198287 |
| counterfactual.partial_50pct_at_1r.median_r | 0.442436 |
| counterfactual.partial_50pct_at_1r.win_rate | 0.611561 |
| counterfactual.partial_50pct_at_1r.profit_factor | 1.256423 |
| counterfactual.time_exit_after_4_bars_if_mfe_lt_0_3r.trade_count | 865 |
| counterfactual.time_exit_after_4_bars_if_mfe_lt_0_3r.avg_r | 0.172369 |
| counterfactual.time_exit_after_4_bars_if_mfe_lt_0_3r.median_r | -0.185018 |
| counterfactual.time_exit_after_4_bars_if_mfe_lt_0_3r.win_rate | 0.455491 |
| counterfactual.time_exit_after_4_bars_if_mfe_lt_0_3r.profit_factor | 1.149602 |
| counterfactual.trail_0_5r_after_1_0r.trade_count | 865 |
| counterfactual.trail_0_5r_after_1_0r.avg_r | 0.368921 |
| counterfactual.trail_0_5r_after_1_0r.median_r | 0.733788 |
| counterfactual.trail_0_5r_after_1_0r.win_rate | 0.789595 |
| counterfactual.trail_0_5r_after_1_0r.profit_factor | 1.646666 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| position_exit | 652 | 1.462467 | 0.573113 | 0.634969 | 4.095200 | -1.635770 | 2.632733 | 27.418712 | 5.388511 | 0.996933 | 0.930982 | 0.832822 |
| reversal | 213 | -3.711919 | -3.125170 | 0.037559 | 1.705804 | -5.417315 | 5.417722 | 24.431925 | 0.046231 | 0.981221 | 0.718310 | 0.460094 |
...
| Metric | Value |
| --- | --- |
| cost_x1.cumulative_return | 0.189852 |
| cost_x1.annualized_return | 0.042034 |
| cost_x1.annualized_vol | 0.392348 |
| cost_x1.sharpe | 0.107135 |
| cost_x1.max_drawdown | -0.517085 |
| cost_x1.profit_factor | 1.013444 |
| cost_x1.hit_rate | 0.478942 |
| cost_x2.cumulative_return | 0.000620 |
| cost_x2.annualized_return | 0.000147 |
| cost_x2.annualized_vol | 0.392471 |
| cost_x2.sharpe | 0.000374 |
| cost_x2.max_drawdown | -0.546956 |
| cost_x2.profit_factor | 1.008749 |
| cost_x2.hit_rate | 0.478561 |
| cost_x3.cumulative_return | -0.158535 |
| cost_x3.annualized_return | -0.040062 |
| cost_x3.annualized_vol | 0.392608 |
| cost_x3.sharpe | -0.102040 |
| cost_x3.max_drawdown | -0.579669 |
| cost_x3.profit_factor | 1.004087 |
| cost_x3.hit_rate | 0.477714 |
| cost_x5.cumulative_return | -0.404966 |
| cost_x5.annualized_return | -0.115708 |
| cost_x5.annualized_vol | 0.392919 |
| cost_x5.sharpe | -0.294482 |
| cost_x5.max_drawdown | -0.678016 |
| cost_x5.profit_factor | 0.994863 |
| cost_x5.hit_rate | 0.476063 |

### Entry Delay
| Metric | Value |
| --- | --- |
| delay_1_bars.cumulative_return | -0.631580 |
| delay_1_bars.annualized_return | -0.148274 |
| delay_1_bars.annualized_vol | 0.664919 |
| delay_1_bars.sharpe | -0.222996 |
| delay_1_bars.max_drawdown | -0.884189 |
| delay_1_bars.profit_factor | 1.003002 |
| delay_1_bars.hit_rate | 0.482251 |
| delay_2_bars.cumulative_return | -0.409675 |
| delay_2_bars.annualized_return | -0.081227 |
| delay_2_bars.annualized_vol | 0.666457 |
| delay_2_bars.sharpe | -0.121879 |
| delay_2_bars.max_drawdown | -0.862772 |
| delay_2_bars.profit_factor | 1.006778 |
| delay_2_bars.hit_rate | 0.483169 |
...
| min_fold_cumulative_return | -0.281725 |
| median_fold_cumulative_return | 0.0 |
| mean_fold_cumulative_return | 0.068592 |
| mean_fold_sharpe | 0.123098 |
| std_fold_sharpe | 0.577773 |
| worst_fold_max_drawdown | -0.454264 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 |  | 0.639227 | 0.621327 | 0.017900 | 14.411589 | 0.040868 |  |  |  |  |
| 1 |  | 0.185872 | 0.167172 | 0.018700 | 0.535074 | 0.042694 |  |  |  |  |
| 2 |  | 0.183772 | 0.165672 | 0.018100 | 0.885383 | 0.041324 |  |  |  |  |
| 3 |  | 0.040427 | 0.023927 | 0.016500 | 0.048861 | 0.037671 |  |  |  |  |
| 4 |  | 0.126048 | 0.109348 | 0.016700 | 1.345877 | 0.038128 |  |  |  |  |
| 5 |  | -0.100652 | -0.114152 | 0.013500 | -1.469783 | 0.030822 |  |  |  |  |
| 6 |  | 0.077438 | 0.061738 | 0.015700 | 0.688220 | 0.035845 |  |  |  |  |
| 7 |  | -0.358029 | -0.377129 | 0.019100 | -1.799270 | 0.043607 |  |  |  |  |
| 8 |  | 0.236786 | 0.218686 | 0.018100 | 2.278234 | 0.041324 |  |  |  |  |
| 9 |  | -0.044348 | -0.063248 | 0.018900 | -0.611645 | 0.043151 |  |  |  |  |
