...
_PIPELINE_COMPONENTS: tuple[tuple[str, PipelineFn], ...] = (
    ...
    ("alpha_discovery_v2", run_alpha_discovery_pipeline),
    ("alpha_discovery_v3", run_alpha_discovery_v3_pipeline),
    ("alpha_discovery_v4", run_alpha_discovery_v4_pipeline),
...
def _validate_alpha_discovery_v2_config(cfg: dict[str, Any]) -> None:
...
def _validate_alpha_discovery_v3_config(cfg: dict[str, Any]) -> None:
...
def _validate_alpha_discovery_v4_config(cfg: dict[str, Any]) -> None:
...
_PIPELINE_CONFIG_VALIDATOR_COMPONENTS: tuple[tuple[str, PipelineConfigValidator], ...] = (
    ...
    ("alpha_discovery_v2", _validate_alpha_discovery_v2_config),
    ("alpha_discovery_v3", _validate_alpha_discovery_v3_config),
    ("alpha_discovery_v4", _validate_alpha_discovery_v4_config),
