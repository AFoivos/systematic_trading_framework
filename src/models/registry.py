...
_SINGLE_ASSET_MODEL_COMPONENTS: tuple[tuple[str, SingleAssetModelFn], ...] = (
    ...
    ("qms_candidate_transform", lazy_callable("src.models.transforms.qms_candidate", "apply_qms_candidate_transform")),
    ("qms_candidate_policy_transform", lazy_callable("src.models.transforms.qms_candidate_policy", "apply_qms_candidate_policy_transform")),
    ...
    ("chronos_bolt_forecaster", lazy_callable("src.models.forecasting.base", "train_chronos_bolt_forecaster")),
    ("chronos_2_forecaster", lazy_callable("src.models.forecasting.base", "train_chronos_2_forecaster")),
    ("timesfm_2p5_200m_forecaster", lazy_callable("src.models.forecasting.base", "train_timesfm_2p5_200m_forecaster")),
