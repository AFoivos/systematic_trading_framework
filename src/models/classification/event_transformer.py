...
def train_event_transformer_encoder(
    ...
    pred_is_oos_col = str(cfg.get("pred_is_oos_col") or "pred_is_oos")
    ...
    feature_cols = infer_feature_columns(
        ...
        exclude={label_col, pred_prob_col, pred_is_oos_col} if pred_prob_col else {label_col, pred_is_oos_col},
    )
    if not feature_cols:
