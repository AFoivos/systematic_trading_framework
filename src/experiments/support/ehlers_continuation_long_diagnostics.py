...
_SIGNAL_COUNT_COLUMNS = {
    "ema50_gt_ema100_rows": "ehlers_continuation_ema50_gt_ema100",
    "mama_gt_fama_rows": "ehlers_continuation_mama_gt_fama",
    "roofing_gt_zero_rows": "ehlers_continuation_roofing_gt_zero",
    "roofing_slope_gt_zero_rows": "ehlers_continuation_roofing_slope_gt_zero",
    "roofing_gt_slope_rows": "ehlers_continuation_roofing_gt_slope",
    "decycler_osc_gt_zero_rows": "ehlers_continuation_decycler_osc_gt_zero",
    "final_long_state_rows": "ehlers_continuation_long_state",
    "final_long_entry_rows": "ehlers_continuation_long_entry",
}
...
def compute_ehlers_continuation_long_diagnostics(
    df: pd.DataFrame,
    *,
    performance: Any,
    robustness: Mapping[str, Any] | None = None,
    signal_col: str = "ehlers_continuation_signal",
    state_col: str = "ehlers_continuation_long_state",
    entry_col: str = "ehlers_continuation_long_entry",
) -> dict[str, Any]:
    ...
    for key, column in _SIGNAL_COUNT_COLUMNS.items():
        if column == "ehlers_continuation_long_state":
            column = state_col
        elif column == "ehlers_continuation_long_entry":
            column = entry_col
        signal_counts[key] = _truthy_count(df, column)
    signal_counts["actual_trade_count"] = int(len(trades))

    ema = _truthy(df, "ehlers_continuation_ema50_gt_ema100")
    mama = _truthy(df, "ehlers_continuation_mama_gt_fama")
    roofing = (
        _truthy(df, "ehlers_continuation_roofing_gt_zero")
        & _truthy(df, "ehlers_continuation_roofing_slope_gt_zero")
        & _truthy(df, "ehlers_continuation_roofing_gt_slope")
    )
    overlap_diagnostics = {
...
__all__ = ["compute_ehlers_continuation_long_diagnostics"]
