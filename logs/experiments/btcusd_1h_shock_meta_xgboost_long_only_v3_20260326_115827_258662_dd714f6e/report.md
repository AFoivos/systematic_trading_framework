# Experiment Report: btcusd_1h_shock_meta_xgboost_long_only_v3

## Overview
- Config path: `/workspace/config/experiments/btcusd_1h_shock_meta_xgboost_long_only_v3.yaml`
...
```yaml
config_path: /workspace/config/experiments/btcusd_1h_shock_meta_xgboost_long_only_v3.yaml
runtime:
  seed: 7
  repro_mode: strict
  deterministic: true
...
data:
  ...
  storage:
    mode: cached_only
    dataset_id: btcusd_1h_shock_meta_xgboost_long_only_v3
    save_raw: false
    save_processed: true
...
- `signal[probability_threshold]` -> `src.signals.probabilistic_signal.probabilistic_signal(df: 'pd.DataFrame', prob_col: 'str', signal_col: 'str | None' = None, upper: 'float' = 0.55, lower: 'float' = 0.45, upper_exit: 'float | None' = None, lower_exit: 'float | None' = None, mode: 'str' = 'long_short_hold', base_signal_col: 'str | None' = None) -> 'pd.Series'`  
  params={'prob_col': 'pred_prob', 'signal_col': 'signal_prob_threshold', 'base_signal_col': 'shock_side_contrarian_active', 'upper': 0.56, 'upper_exit': 0.5, 'lower': 0.43, 'lower_exit': 0.48, 'mode': 'long_only'}
...
| Metric | Value |
| --- | --- |
| cumulative_return | 0.129220 |
| annualized_return | 0.021773 |
| annualized_vol | 0.151526 |
| sharpe | 0.143688 |
| sortino | 0.242121 |
| calmar | 0.105656 |
| max_drawdown | -0.206070 |
| profit_factor | 1.073419 |
| hit_rate | 0.428846 |
...
| 7 | 336 | 0.010945 | 0.008345 | 0.002600 | 5.644624 | 0.011905 |  |  |  |  |
